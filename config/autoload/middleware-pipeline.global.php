...
use EmailMkt\Application\Form\{
    CityForm,CustomerForm,LoginForm
};
use EmailMkt\Application\Form\Factory\{
    CityFormFactory,CustomerFormFactory,LoginFormFactory
};
...
return [
    ...
    'middleware_pipeline' => [
        ...
        'always' => [
            ...
            //isso determina a ordem de execução > antes, se não tiver nada, a prioridade é assumida como 1
            //depois do número é levada em conta a ordem
            'priority' => 10000,
        ],
        'admin' => [
            'path' => '/admin',
