...
unset($doctrineModuleConfig['service_manager']);//exclui o service manager
unset($doctrineModuleConfig['dependencies']['factories']['doctrine.cli']);//não server porque está preparado para trabalhar
//com zend framework 2 mas não funciona no zend-expressive
//abaixo cria o serviço com base no zend-expressive - usa a llinha de comandos do symphony para criar os comandos do doctrine
